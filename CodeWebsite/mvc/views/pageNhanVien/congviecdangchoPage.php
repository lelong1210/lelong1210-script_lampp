        ...
        <div class="row table_overView">
            <div class="col-12" id="table_congvc">
                <div class="card">
                    <div class="card-body">
                        <?php
                        $arr = json_decode($data["nhanVienModel"]->getCongViec($_SESSION["username"]));
                        if($arr){
                            $arrTitle = ["Mã Công Việc","Mã Hóa Đơn","Tên Khách Hàng","Địa Chỉ Công Việc","Số Điện Thoại","Tiến Độ","Xem Chi Tiết"];
                        ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <td><button class="btn btn-lg btn-success" id="btn_ht<?php echo $arrChild[0]?>">Xác Nhận HT</button></td>
